...
from assignment.assignment_1.tool.image_iterator import FileFilt
...
# iterate over images under a certain directory
b = FileFilt()
b.FindFile(dirr="../../../data/image/day_2")
...
for image_name in b.fileList[600:800]:
